...
class CollectionTableTypeExtension extends AbstractTypeExtension
{
    public function finishView(FormView $view, FormInterface $form, array $options): void
    {
        ...
        foreach ($view as $entryView) {
            ...
            if (\in_array('collection_table_entry', $entryView->vars['block_prefixes'], true)) {
                continue;
            }
        ...
        if (null !== $prototype) {
            ...
            // needed to avoid 'Unable to render the form because the block names array contains duplicates'
            if (!\in_array('collection_table_entry', $view->vars['prototype']->vars['block_prefixes'], true)) {
    ...
    {
        return [CollectionTableType::class];
    }
}
